...
namespace taxi_app
{
    public class Taxi
    {
        ...
        {
            Console.WriteLine($"Driver's name = {DriverName}");
            if(OnDuty == true)
            {
        ...
        public void PickUpPassanger()
        {
            ...
            {
                Console.WriteLine($"{DriverName} tidak sedang menjemput penumpang");
            }
        }
        ...
        public void DropOffPassanger()
        {
            ...
            {
                Console.WriteLine($"{DriverName} belom selesai mengantar penumpang");
            }
        }
    }
}
